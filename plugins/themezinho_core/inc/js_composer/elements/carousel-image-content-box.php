...
class WPBakeryShortCode_ts_carousel_image_content_box extends WPBakeryShortCode {
  ...
  protected function content( $atts, $content = null ) {
    ...
    ?>
<div class="carousel-image-box <?php echo esc_attr( $wrapper_class ); ?>" <?php if( $animate_block == 'yes' && $animation_delay != '' ) { echo 'data-wow-delay="' . esc_attr( $animation_delay ) . '"'; } ?>>
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide">
      ...
      <div class="content">
        ...
        <h5><a href="<?php echo esc_url($accordion['url']);?>"><?php echo esc_html($accordion['title']);?></a></h5>
        <?php } ?>
...
vc_map( array(
  "base" => "ts_carousel_image_content_box",
  "name" => __( 'Carousel Image Content Box', 'themezinho' ),
